...
<div class="container-fluid">
    ...
    <button type="button" class="btn btn-primary mb-3 btn-sm" data-toggle="modal" data-target="#tambahkertasroll">Tambah
        Kertas Roll</button>
    ...
    <table class="table table-bordered table-hover table-striped">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?= $rp['sisa'] ?></td>
                <td><?= $rp['harga'] ?></td>
                <td> <a href="<?= base_url('Akuntansi/editKertasRoll'); ?>/<?= $rp['id']; ?>"
                        class="badge badge-info"><i class="fas fa-fw fa-pen"></i>edit</a> </td>
            </tr>
            <?php
            endforeach;
            ?>
