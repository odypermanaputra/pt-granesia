    ...
    <form action="" method="POST" name="autoSumForm" autocomplete="off">
        ...
        <div class="form-row">
            ...
            <div class="form-group col-md-6">
                ...
                <input type="text" class="form-control" id="no_dok" name="no_dok"
                    onkeyup="this.value = this.value.toUpperCase();" value="<?= $dataPembelian['no_dok']; ?>">
        ...
        <div class="form-row">
            <div class="form-group col-md-3">
                ...
                <input list="data-barang" type="text" class="form-control" id="kode_barang" name="kode_barang"
                    onchange="return autofill()" value="<?= $dataPembelian['kode_barang']; ?>" readonly>
                <?= form_error('kode_barang', '<small id="kode_barang" class="form-text text-danger ml-2">', '</small>'); ?>
            </div>
            <div class="form-group col-md-4">
                <label for="nama_barang">Nama Barang :</label>
                <input type="text" class="form-control" id="nama_barang" name="nama_barang"
                    value="<?= $dataPembelian['nama_barang']; ?>" readonly>
                <?= form_error('nama_barang', '<small id="nama_barang" class="form-text text-danger ml-2">', '</small>'); ?>
            </div>
            <div class="form-group col-md-2">
                <label for="qty">Quatity :</label>
                <input type="text" class="form-control" id="qty" name="qty" onfocus="startCalc();" onBlur="stopCalc();"
                    value="<?= $dataPembelian['qty']; ?>" readonly>
        ...
        <div class="form-row">
            <div class="form-group col-md-8">
                ...
                <input type="text" class="form-control" id="keterangan" name="keterangan"
                    value="<?= $dataPembelian['keterangan']; ?>">
        ...
        <div class="form-row">
            <div class="form-group col-md-3">
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="text" class="form-control" id="hrg_satuan" name="hrg_satuan" onfocus="startCalc();"
                        onBlur="stopCalc();" value="<?= $dataPembelian['hrg_satuan']; ?>">
            ...
            <div class="form-group col-md-4">
                ...
                <div class="input-group mb-3">
                    ...
                    <input type="text" class="form-control" id="jumlah" name="jumlah" onfocus="startCalc();"
                        onBlur="stopCalc();" readonly value="<?= $dataPembelian['jumlah']; ?>">
