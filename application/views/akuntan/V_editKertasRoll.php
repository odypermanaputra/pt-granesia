        ...
        <div class="card-body">
            <form action="" method="POST" autocomplete="off">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control form-control-sm datepicker" id="tgl_masuk" name="tgl_masuk" value="<?= $rollpaperbyId['tgl_masuk'] ?>">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="text" class="form-control form-control-sm" id="kode_roll" name="kode_roll" value="<?= $rollpaperbyId['kode_roll'] ?>">
                    ...
                    <div class="col-sm-9">
                        <select name="jenis_kertas_id" id="jenis_kertas_id" class="form-control form-control-sm">
                            <?php foreach ($jeniskertas as $jk) : ?>
                                <?php if ($jk['id'] == $rollpaperbyId['jenis_kertas_id']) : ?>
                                    <option value="<?= $jk['id'] ?>" selected><?= $jk['jenis_kertas'] ?></option>
                                <?php else : ?>
                                    <option value="<?= $jk['id'] ?>"><?= $jk['jenis_kertas'] ?></option>
                            <?php
                                endif;
                            endforeach;
                            ?>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input type="float" class="form-control form-control-sm bg-gradient-info text-white" id="weight" name="weight" value="<?= $rollpaperbyId['weight'] ?>">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <div class="input-group input-group-sm">
                            ...
                            <input type="numeric " step="0.01" size="10" class="form-control form-control-sm" name="harga" value="<?= $rollpaperbyId['harga'] ?>">
                        </div>
